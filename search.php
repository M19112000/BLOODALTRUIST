            ...
            <div class="col-md-8 col-md-offset-2 text-xs-center">
                ...
                <div class="lead">
                    <form action="search_result.php" id="search_form" method="GET">
                        ...
                        <button type="submit"  style="border:0px;  width:150px; height:36px; border-radius: 10px;  box-shadow:1px 1px 5px black; color:black; font-weight: 600; font-size:18px; background-color:red;"><a class="nav-link link" href="search_result.html">Search Result</a></button>
                    </form>
